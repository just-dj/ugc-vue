  ...
  export default {
    ...
    data() {
      return {
        ...
        swiperData:[
          {
            headImg:"https://justdj-ugc.oss-cn-hangzhou.aliyuncs.com/10.jpg",
            nickname:"强仔"
          },
          {
            headImg:"https://justdj-ugc.oss-cn-hangzhou.aliyuncs.com/3.jpg",
            nickname:"强子"
          },
          {
            headImg:"\n" +
            "https://justdj-ugc.oss-cn-hangzhou.aliyuncs.com/16.jpg",
            nickname:"强强"
          }
        ]
      }
