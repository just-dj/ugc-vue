    ...
    <el-container class="el-container main-page" style="background-color: rgb(238,238,238)">
      <el-header style="position: relative;background-color: #545c64;padding: 0 9rem;">
        ...
        <el-menu :default-active="this.$route.path"
                 ...
                 @select="handleSelect">
          <el-menu-item index="/blogPage" key="11">博客</el-menu-item>
          <el-menu-item index="/bbsPage" key="22">论坛</el-menu-item>
          <el-menu-item index="/meetingPage" key="33">会议纪要</el-menu-item>
          <el-menu-item index="/managerIndex" key="44" v-if="managerIndex">系统管理</el-menu-item>
        </el-menu>
      ...
      <el-main style="margin: 15px 8.1rem 15px 8.1rem;padding: 10px 0.9rem 10px 0.9rem;background-color: blue">
        博客
        <keep-alive>
